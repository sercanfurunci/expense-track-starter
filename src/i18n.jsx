...
const translations = {
  en: {
    ...
    landingSubtitle: "Log what you earn and spend. See it in charts. Understand your habits over time.",
    landingGetStarted: "Create free account",
    landingSignIn: "Sign in",
    landingFeaturesLabel: "How it works",
    landingFeaturesTitle: "Three things,",
    landingFeaturesTitle2: "done well.",
  ...
  tr: {
    ...
    landingSubtitle: "Kazandıklarınızı ve harcadıklarınızı kaydedin. Grafiklerde görün. Alışkanlıklarınızı zamanla anlayın.",
    landingGetStarted: "Ücretsiz hesap oluştur",
    landingSignIn: "Giriş yap",
    landingFeaturesLabel: "Nasıl çalışır",
    landingFeaturesTitle: "Üç şey,",
    landingFeaturesTitle2: "iyi yapılmış.",
